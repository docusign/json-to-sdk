...
SUB_DIR=${PWD##*/}
if [ ${SUB_DIR} != "json-to-sdk" ]
then
    printf 'Problem! Current subdirectory is not "json-to-sdk"!\n'
...
cp -f src/assets/documents/blank.pdf        src/assets/sdkExamples/Python_example/src/main/resources
cp -f src/assets/documents/anchorfields.pdf src/assets/sdkExamples/Python_example/src/main/resources
cp -f src/assets/documents/blank.pdf        src/assets/sdkExamples/Ruby_example/src/main/resources
cp -f src/assets/documents/anchorfields.pdf src/assets/sdkExamples/Ruby_example/src/main/resources
